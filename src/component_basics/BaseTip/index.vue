...
<style lang="less" rel="stylesheet/less" scoped>
  ...
  .tip-top-enter, .tip-top-leave-to {
    transform: translate3d(0, -100%, 0)
  }
  .tip-top-enter-active, .tip-top-leave-active, .tip-bottom-enter-active, .tip-bottom-leave-active  {
    transition: all 0.5s
  }
  .tip-bottom-enter, .tip-bottom-leave-to {
    transform: translate3d(0, 100%, 0)
  }
